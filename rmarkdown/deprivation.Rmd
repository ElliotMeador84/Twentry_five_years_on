...
scotland_dep_df <- read_csv('C:/Users/emeador/OneDrive - SRUC/Data/deprivation/scotland/simd2016_withgeog/simd2016_withinds.csv') %>% 
  clean_names()

england_dep_df <- read.xlsx('C:/Users/emeador/OneDrive - SRUC/Data/deprivation/england/england_dep_scores_2019.xlsx', sheet = 'IoD2019 Scores') %>% 
  as_tibble() %>% 
  clean_names()
