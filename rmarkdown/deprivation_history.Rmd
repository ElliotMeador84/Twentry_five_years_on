...
scotland_deprivation_scores %>% 
  ...
  labs(title = 'Comparing Scottish Domains of Deprivation Over Time', 
       ...
       caption = 'NOTE: Varying scales on vertical axis.')
```
...
2. 0.31 - .6 Medium-strong correlation
...
corrplot(M, method="color", col=col(200),  
         ...
         diag=FALSE ,
         title = 'Statistical correlations in Scottish Deprivation 2016',
          mar = c(1, 1, 1, 1)
...
corrplot(M, method="color", col=col(200),  
         ...
         # hide correlation coefficient on the principal diagonal
         diag=FALSE ,
         title = 'Statistical correlations in English Deprivation 2019',
          mar = c(1, 1, 1, 1)
